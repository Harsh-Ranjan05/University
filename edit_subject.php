...
if(isset($_POST['submit'])){
    ...
    $result=pg_query($conn, $query);
    if($result){
         echo "<script>alert('Update Successfully..'); window.location='subject.php';</script>";
    }else{
      ...
      <div class="form-container">
        ...
        <form method="POST">
          <div class="form-group">
            ...
            <input type="text" id="name" name="subject_name" value="<?php echo $subject_name; ?>" placeholder="Enter subject name">
              <label for="name">Subject Code</label>
            <input type="text" id="name" name="subject_code" value="<?php echo $subject_code; ?>" placeholder="Enter subject code">
          </div>
