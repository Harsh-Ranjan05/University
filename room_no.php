...
if(isset($_POST['submit'])){
    ...
    $query="INSERT INTO room_no(room_no) VALUES('$room_no')";
    $result=pg_query($conn, $query);
    if($result){
    echo "<script>alert('Added Successfully..'); window.location='room_no.php';</script>";
    }else{
    echo "<script>alert('Failed To Added..'); window.location='room_no.php';</script>";
    }
}
?><!DOCTYPE html>
<html lang="en">
      ...
      <div class="form-container">
        ...
        <form method="POST">
          <div class="form-group">
            ...
            <input type="text" id="name" name="room_no" placeholder="Enter Room No.">
          </div>
