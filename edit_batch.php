...
if(isset($_POST['submit'])){
    ...
    $result=pg_query($conn, $query);
    if($result){
         echo "<script>alert('Update Successfully..'); window.location='batch.php';</script>";
    }else{
      ...
      <div class="form-container">
        ...
        <form method="POST">
          <div class="form-group">
            ...
            <input type="text" id="name" name="batch" value="<?php echo $batch; ?>" placeholder="Enter Batch">
          </div>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php 
if ($res['status'] == 1) { ?>
    <a href="status.php?table=batch&id=<?php echo $res['id']; ?>" class="btn-1">Active</a>
<?php } else { ?>
    <a href="status.php?table=batch&id=<?php echo $res['id']; ?>" class="btn-2">Deactive</a>
<?php } ?></td>
              <td><a href="edit_batch.php?&id=<?php echo $res['id']; ?>" class="btn-1">Edit</a></td>
            </tr>
            <?php } ?>
          </tbody>
        </table>
